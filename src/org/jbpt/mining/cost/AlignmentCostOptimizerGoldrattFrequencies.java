...
public class AlignmentCostOptimizerGoldrattFrequencies extends AbstractAlignmentCostOptimizer {
	...
	public int findOptimalCost(int resources) {
		...
		if (this.outputFlag) System.out.println("Original MOM costs: "+ mapTrans2Cost);
		if (this.outputFlag) System.out.println("Original MOL costs: "+ mapEvClass2Cost);
		if (this.outputFlag) System.out.println("Misalignment frequencies: " + frequencies);
		...
		if (this.outputFlag) System.out.println("Weighted MOM costs: "+tmpTrans2Cost);
		...
		if (this.outputFlag) System.out.println("Weighted MOL costs: "+tmpEvClass2Cost);
		...
		if (this.outputFlag) System.out.println("Optimal MOM costs: "+this.optTrans2Cost);
		if (this.outputFlag) System.out.println("Optimal MOL costs: "+this.optEvClass2Cost);
